...
// Analyze ưu tiên
if (
    /(phân tích|đánh giá|nhận xét).*(tôi|bản thân)|phân tích về tôi/i.test(text) ||

    /điểm mạnh/i.test(text) ||

    /tôi giỏi gì/i.test(text) ||

    /hợp nghề/i.test(text) ||

    /nên làm nghề/i.test(text) ||
